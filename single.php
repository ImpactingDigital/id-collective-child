...
<div class="<?php echo esc_attr($container_type);?>">
	<div class="row margin-bottom-lg">
		...
		<div class="col-md-2 text-right single-blog-details category">
			<div class="margin-bottom-lg">
				<p class="text-uppercase margin-bottom-xs"><?php esc_html_e('categoria','collective');?></p>
				<?php
			...
			<div class="margin-bottom-lg">
				<p class="text-uppercase margin-bottom-xs details-author"><?php esc_html_e('autor','collective');?></p>
